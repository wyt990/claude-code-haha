...
const ULTRAPLAN_INSTRUCTIONS: string = MACRO.BUILD_IS_ANT && process.env.ULTRAPLAN_PROMPT_FILE ? readFileSync(process.env.ULTRAPLAN_PROMPT_FILE, 'utf8').trimEnd() : DEFAULT_INSTRUCTIONS;
...
export default {
  type: 'local-jsx',
  name: 'ultraplan',
  description: `约 10–30 分钟 · 在网页版 Claude Code 中起草可编辑、可批准的高级计划。详见 ${CCR_TERMS_URL}`,
  argumentHint: '<prompt>',
  isEnabled: () => MACRO.BUILD_IS_ANT,
