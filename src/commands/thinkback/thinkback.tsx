...
function getMarketplaceName(): string {
  return MACRO.BUILD_IS_ANT ? INTERNAL_MARKETPLACE_NAME : OFFICIAL_MARKETPLACE_NAME;
}
function getMarketplaceRepo(): string {
  return MACRO.BUILD_IS_ANT ? INTERNAL_MARKETPLACE_REPO : OFFICIAL_MARKETPLACE_REPO;
}
