...
export function GuestPassesUpsell() {
  ...
  if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
    ...
    t0 = <Text dimColor={true}><Text color="claude">[✻]</Text> <Text color="claude">[✻]</Text>{" "}<Text color="claude">[✻]</Text> ·{" "}{reward ? `分享 Claude Code，可获得 ${formatCreditAmount(reward)} 额外用量 · /passes` : "3 张亲友体验券 · /passes"}</Text>;
    $[0] = t0;
  } else {
    t0 = $[0];
  }
