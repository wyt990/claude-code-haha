...
export function IdeOnboardingDialog(t0) {
  ...
  const t7 = installedVersion
    ? `已安装${isJetBrains ? '插件' : '扩展'} v${installedVersion}`
    : undefined;
  let t8;
  ...
  if ($[11] === Symbol.for("react.memo_cache_sentinel")) {
    t9 = <Text>• Claude 可感知 {t8}{" "}与 <Text color="suggestion">⧉ 选中的行</Text></Text>;
    $[11] = t9;
  } else {
    t9 = $[11];
  }
  ...
  if ($[13] === Symbol.for("react.memo_cache_sentinel")) {
    t11 = <Text>• 在 IDE 中审阅 Claude Code 的改动{" "}{t10}{" "}<Text color="diffRemovedWord">-22</Text></Text>;
    $[13] = t11;
  } else {
    t11 = $[13];
  }
