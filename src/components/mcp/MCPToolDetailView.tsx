...
function _temp(exitState) {
  return exitState.pending ? <Text>再按一次 {exitState.keyName} 退出</Text> : <ConfigurableShortcutHint action="confirm:no" context="Confirmation" fallback="Esc" description="返回" />;
}
